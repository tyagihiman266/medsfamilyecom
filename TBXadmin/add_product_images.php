...
<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
 ...
 <?php $rowsalt=$objT->getResult('select * from tbl_product where status=1 order by name asc'); ?>
                      <select name="id" class="form-control myselect" >
                        ...
                        <label>Varient</label>
                        <input type="text" name="varient" id="varient" style="margin-top:20px;margin-bottom:10px">
                        <label>Varient Unit</label>
                        <input type="text" name="varientunit" id="varientunit" style="margin-top:20px;margin-bottom:10px">
