...
{   
  ...
  'created_date' => date('y:m:d') );
		...
		$query1 = $objC->GiftIdeaReply($message_id,$message,$send_by,$user_status,$admin_status,$created_date);
		
	 if($query1)
	{
		$sms = "<p style='text-align:center;color:green;'>Message send successfully</p>"; 
		header("refresh:2;url=view_giftidea.php");   
...
if(isset($_REQUEST['view']))
     { 
     $id=$_REQUEST['view'];
      $row = $objT->getResultById('giftidea_data',$id); 
      $user_id  = $row['user_id'] ;
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-warning" style="width=200px">
                <div class="box-header with-border">
                  <h3 class="box-title">Customer Gift Idea</h3>
				  <?php if(isset($sms)){
					  echo $sms;
				  } ?>
               ...
               <textarea readonly name="message" class="form-control" rows="3" ><?php echo $row['message'] ;?></textarea>
					...
					<div style="float:right;">
                     <input type="submit" class="btn btn-success" name="submit" id="submit" value="Reply">
				   </div>
				   
				   <?php 
				   $sqlR = mysql_query("Select * from giftidea_reply_data where message_id = '".$row['id']."'");
