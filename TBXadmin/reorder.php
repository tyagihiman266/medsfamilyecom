      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="form-group">
                      ...
                      <input type="text" name="Country" value="<?php echo (isset($_REQUEST['edit'])?$row1['Country']:"");?>" class="form-control" placeholder="Name..." />
                    </div>
                     <div class="form-group">
                      <label>Email</label>
                      <input type="text" name="number" value="<?php echo (isset($_REQUEST['edit'])?$row1['number']:"");?>" class="form-control" placeholder="Email..." />
                    </div>
					 <div style="margen-left:140px;">
                         <?php if(!isset($_REQUEST['edit'])) {?>
                                                        ...
                                                        <?php  }  else {?>             
                                                        <input type="submit" class="btn btn-success" name="Update" id="Update" value="ReOrder">
                                                        <input type="button" class="btn btn-info" value=" Cancel" onClick="window.location.href = 'manage_number'"> 
                                                        <?php  } ?>   
                      </div>
        </form>
