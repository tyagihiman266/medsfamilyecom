...
die;*/
    if(!empty($nbuffer[0]) ){
 $sql = "insert into product_varient set  ";
                  $i=0;
          ...
          $sql.=" ,varient='".$nbuffer[$i]."'";
          $i=$i+1;
         
                 
          $sql.=" ,varient_unit='".$nbuffer[$i]."'";
          $i=$i+1;
          $sql.=" ,varient_img='".$nbuffer[$i]."'";
          $i=$i+1;
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Import Product Varient</title>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-warning" style="width=200px">
                <div class="box-header with-border">
                  <h3 class="box-title">Import Varient</h3>
				  <?php if(isset($sms)){
					  echo $sms;
				  } ?>
                ...
                <div class="box-body">
                   ...
                   <form name="mgaform" id="mgaform" method="post" action="" enctype="multipart/form-data" >
                      ...
                      <input type="file"  name="import_file_name" class="form-control"  />
                           <br/>
                      <a href="product_varient.csv"><b>Download Sample</b> </a>
                    </div>
