...
if(isset($_GET['ids'])){
	...
	$sql = $user->QueryDelete('build_survey',$deleteid);
	
	if($sql){
		$sms = "<p style='text-align:center;color:green;'>Survey deleted successfully</p>"; 
		header("refresh:5;url=building_survey.php");
...
{
   $query= $user->updateStatus('build_survey',"status",$_GET['active'],$_GET['id']);
}	
	$query = "SELECT * FROM build_survey where status='1' ";
	if($_REQUEST['date']!=''){
		$query .= " and date_cr='".$_REQUEST['date']."' ";
	}
	$query .= " order by build_survey_id desc";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Manage Building Survey
            
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li> >> 
            Manage Building Survey</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
			  ...
			  <form id="tab" name="form1" method="get" action="">
                <div class="box-header">
					<h3 class="box-title">Manage Building Survey</h3>
					<!--<div class="col-md-12">
				...
				<tr>
                        ...
                        <td><?php echo $results[$x]['building_id']; ?></td>
                        ...
                        <td><?php echo $results[$x]['ward_no']; ?></td>
                        <td><?php echo $results[$x]['locality']; ?></td>
                        <td><?php echo $results[$x]['road_name']; ?></td>
                        <td><?php echo $results[$x]['land_use']; ?></td>
                        <td><?php echo $results[$x]['landuse_detail']; ?></td>
                        <td><?php echo $results[$x]['cons_type']; ?></td>
                        <td><?php echo $results[$x]['build_floor']; ?></td>
						...
						<td><a href="building_survey.php?ids=<?php echo $results[$x]['build_survey_id'];?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure want to delete')">Delete</a></td>
                      </tr>
             <?php $x++;$i++;}?>
