...
if(isset($_GET['ids'])){
	...
	$sql = $user->QueryDelete('light_survey',$deleteid);
	
	if($sql){
		$sms = "<p style='text-align:center;color:green;'>Survey deleted successfully</p>"; 
		header("refresh:5;url=light_survey.php");
...
{
   $query= $user->updateStatus('light_survey',"status",$_GET['active'],$_GET['id']);
}	
	$query = "SELECT * FROM light_survey where status='1' ";
	if($_REQUEST['date']!=''){
		$query .= " and date_cr='".$_REQUEST['date']."' ";
	}
	$query .= " order by light_survey_id desc";
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Manage Street Light Survey
            
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li> >> 
            Manage Street Light Survey</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
			  ...
			  <form id="tab" name="form1" method="get" action="">
                <div class="box-header">
					<h3 class="box-title">Manage Street Light Survey</h3>
					<!--<div class="col-md-12">
				...
				<tr>
						...
						<td><?php echo $results[$x]['sl_id']; ?></td>
						...
						<th><?php echo $results[$x]['pole_type']; ?></th>
						<th><?php echo $results[$x]['street_light']; ?></th>
						<th><?php echo $results[$x]['source']; ?></th>
						...
						<td><a href="light_survey.php?ids=<?php echo $results[$x]['light_survey_id'];?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure want to delete')">Delete</a></td>
                      </tr>
             <?php $x++;$i++;}?>
