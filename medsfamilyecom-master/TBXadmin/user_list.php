            ...
            <div class="col-xs-12">
			  ...
			  <form id="tab" name="form1" method="post" action="">
                <div class="box-header">
				  ...
				  <div style="float:right;"><a href="add_user"><span class="btn btn-success btn-small">Add Customer</span></a>
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>	
                        ...
                        <td><?php echo $results[$x]['email']; ?></td>
                        <td><?php echo $results[$x]['mobile']; ?></td>
                        <td><?php echo $results[$x]['created_data']; ?></td>
                        <td><?php echo $user->getStatus($results[$x]['status']); ?></td>
            						<td><a href="add_user?edit=<?php echo $results[$x]['id'];?>"><span class="btn btn-success btn-xs"><i class="fa fa-edit"></i>Edit</span></a>
