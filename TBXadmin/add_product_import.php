...
die;*/
 ...
 $sql = "insert into tbl_product set  ";
          ...
          $sql.=" ,short_description='".$nbuffer[$i]."'";
          $i=$i+1;
         
                 
                  $sql.=" ,product_description='".$nbuffer[$i]."'";
          $i=$i+1;

           $sql.=" ,safety_information='".$nbuffer[$i]."'";
          $i=$i+1;
            $sql.=" ,side_effects='".$nbuffer[$i]."'";
          $i=$i+1;
           $sql.=" ,other_name='".$nbuffer[$i]."'";
          $i=$i+1;
           $sql.=" ,best_seller='".$nbuffer[$i]."'";
          $i=$i+1;
            $sql.=" ,sku_number='".$nbuffer[$i]."'";
          $i=$i+1;
            $sql.=" ,ingredient='".$nbuffer[$i]."'";
          $i=$i+1;
            $sql.=" ,status='".$nbuffer[$i]."'";
          $i=$i+1;
            $sql.=" ,url_key='".$nbuffer[$i]."'";
          $i=$i+1;
          $sql.=" ,meta_title='".$nbuffer[$i]."'";
          $i=$i+1;
            $sql.=" ,meta_keyword='".$nbuffer[$i]."'";
          $i=$i+1;
            $sql.=" ,meta_description='".$nbuffer[$i]."'";
          $i=$i+1;
           $sql.=" ,created_On='".$nbuffer[$i]."'";
          $i=$i+1;
           $sql.=" ,updated_On='".$nbuffer[$i]."'";
          $i=$i+1;
             $sql.=" ,cat_id='".$nbuffer[$i]."'";
          $i=$i+1;
             $sql.=" ,salt_id='".$nbuffer[$i]."'";
          $i=$i+1;
          $sql.=" ,salt_name='".$nbuffer[$i]."'";
          $i=$i+1;
              ...
              <div class="box box-warning" style="width=200px">
                ...
                <div class="box-body">
                   ...
                   <form name="mgaform" id="mgaform" method="post" action="" enctype="multipart/form-data" >
                      ...
                      <br/>
                      <a href="product.csv"><b>Download Sample</b> </a>
