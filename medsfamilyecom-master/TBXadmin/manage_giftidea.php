			  ...
			  <form id="tab" name="form1" method="post" action="">
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php
						$row=$objT->getResult('select * from giftidea_data order by id desc');
            $count1 = count($row);
            $i=1;
            $j=0;
                     while($count1 > 0){
...
$count = $objT->getResult("Select * from message_reply_data where admin_status = 0 and message_id = '".$row[$j]['id']."' ");
				...
				<td> <input type="checkbox" value="<?php echo $row[$j]['id']; ?>" name="data[]" id="data" title="Select All" /></td> 
						...
						<td><a href="view_giftidea.php?view=<?php echo $row[$j]['id'];?>"><span class="btn btn-success btn-xs"><i class="fa fa-edit"></i>View</span></a></td>
