...
$productsingle=$objU->getResult("select * from tbl_product where id='".$_REQUEST['pid']."'");
   // table manage_category=48 , table tbl_product(id)=18 , $_REQUEST['pid']=18
          ...
          <div role="tabpanel" class="f-tab clearfix">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <?php 
                 ...
                 //echo 'select * from product_varient where product_id="'.$_REQUEST['pid'].'" order by varient asc';
                  $i=0;
            ...
            <div class="tab-content">
                        ...
                        and varient_id="'.$varientval['id'].'" and company_id="'.$_REQUEST['companyid'].'"  order by no_pills asc');
                         //select * from tbl_product_package where product_id="18" and varient_id="24" and company_id="14" order by no_pills asc;  
...
//select varient_img from product_varient_image where product_id='18' and Varient ='0.5'
/* echo "<pre>";
 ...
 if ($varientimg['varient_img']!="") {
  ...
  <?php
   ...
   ?>
              ...
              //user_id is coming from user_data table
                ...
                if($numcartpackage==0) {
        ?>
        <input type="hidden" name="packageid" id="packageid" value="<?php echo $valpackage['id'];?>">
        
        <input type="hidden" name="qty" id="qty" value="<?php echo $valpackage['qty'];?>">
        <div id="myids"></div>
         ...
         $.ajax({
				type: "post",
				url: "http://localhost:27/ecom/ajax/addtocart.php",
				data: {'packageid1':packageid,'qty1':qty},
