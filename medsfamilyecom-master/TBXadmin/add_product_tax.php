<?php
   ...
   <?php
     ...
     { 
    $id=$_REQUEST['edit'];
     $row1 = $objT->getResultById('product_tax',$id);
     }
    ...
    $query = $objT->insertQuery($colArray,'product_tax');
    
    if($query)
    {  
       $sms="<p style='text-align:center;color:green;'>Product Tax Added Successfully.</p>";
       header("refresh:2;url=manage_product_tax.php");   
...
{   
   ...
   $query1 = $objT->updateQuery($colArray,'product_tax',$id);

   if($query1)
	{
		$sms = "<p style='text-align:center;color:green;'>Product Tax updated successfully</p>"; 
		header("refresh:2;url=manage_product_tax.php");   
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="form-group">
                      ...
                      <input type="text" name="tax_label" value="<?php echo (isset($_REQUEST['edit'])?$row1['tax_label']:"");?>" class="form-control" placeholder="Tax Name..." />
					  <input type="hidden" name="id" value="<?php echo (isset($_REQUEST['edit'])?$row1['id']:"");?>" class="form-control"  />
                    </div>
					<div class="form-group">
                      <label>Rate %</label>
                      <input  type="number" step="any"  value="<?php echo (isset($_REQUEST['edit'])?$row1['tax_per']:"");?>" name="tax_per" class="form-control" placeholder="Rate %..." />
                    </div>
