		...
		<div class="row">
			<div class="beardcrumb">
				<ul>
					...
					<li><a href="javascript:void(0);"><?php echo $catname; ?></a></li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				...
				<?php $fulllink = $baselink."category/".$_REQUEST['cat_id'].".htm"; ?>
				<div class="col-md-12 p-0">
...
include("pagination.php");
                ...
                ?>
					<div class="col-md-3 p-0-7">
						<a href="salt/<?php echo $_REQUEST['cat_id']; ?>/<?php  echo buildURL($valproduct['salt_name']); ?>.htm"><div class="feature-wrap">
							<?php 
...
<!--
							...
							<div class="feature-cost text-center">
								<p><?php echo $valproduct['salt_name'] ?></p>
								<!--<span>
