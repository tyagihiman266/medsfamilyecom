      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-warning" style="width=200px">
                <div class="box-header with-border">
                  <h3 class="box-title">Add Number</h3>
				  <?php if(isset($sms)){
					  echo $sms;
				  } ?>
          ...
          <div class="form-group">
                      <label>Country</label>
                      <input type="text" name="Country" value="<?php echo (isset($_REQUEST['edit'])?$row1['Country']:"");?>" class="form-control" placeholder="Country..." />
                    </div>
                     <div class="form-group">
                      <label>Number</label>
                      <input type="text" name="number" value="<?php echo (isset($_REQUEST['edit'])?$row1['number']:"");?>" class="form-control" placeholder="Number..." />
                    </div>
