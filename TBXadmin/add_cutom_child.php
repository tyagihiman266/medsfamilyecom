...
<?php 
    ...
    $type    = $_REQUEST['type'];
      ...
      $color   =  $_POST['color'];
      $status  =  '1';  
      $image   =  $_FILES['fvalue']['name'];
 
			$count = count($name);
      $sqlD = $objT->QueryDelete5('tbl_customization_child',$pcl_id1,$type1);
        ...
        for($x=0; $x < $count; $x++ ){   
              ...
              $name    =  $_POST['name'][$x];
              if($type==1) {
                  $fvalue   =  $_FILES['fvalue']['name'][$x];
            
               } else {
               $fvalue =$_POST['fvalue'][$x];
               }
             
            
          
              $target_dir = "upload/";
              $target_file = $target_dir . basename($fvalue);
              $imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));

               $queryC =  $objT->QueryInsert("INSERT INTO  tbl_customization_child set parent_typeid='".$pcl_id."',type='".$type."',name='".$name."',fvalue='".$fvalue."'");
            /*
               ...
               move_uploaded_file($_FILES["fvalue"]["tmp_name"][$x],$target_file);
    ...
    $rowS   = $objT->getResultById3('tbl_customization_child',$pcl_id);
...
<script src="js/jscolor.js"></script>
  ...
  <body class="skin-blue sidebar-mini">
    ...
    <section class="invoice">
      ...
      <?php if($type == 1) {  ?>
		...
		<div class="entry  row">
         ...
         <input type="file"  title="ex. color, size etc" required="required" name="fvalue[]" id="title"  class="form-control" value=""/>
		</div>
     ...
     $j = 0;
		...
		<div class="entry  row">
         ...
         <div class="form-group col-xs-5">
         <label>Image <span class="required">*</span></label>
         <input type="file"  value="<?php echo $rowS[$j]['fvalue']; ?>" title="ex. color, size etc" required="required" name="fvalue[]" id="title"  class="form-control" value=""/>
		</div>
    ...
    <div class="entry  row">
      <div class="form-group col-xs-5">
       <label>Text Field Name <span class="required">*</span></label>
      <input class="form-control"  required="required" type="text" name="name[]" value=""/>
         ...
         <input type="text" pattern=""  title=""  name="fvalue[]" id="fvalue"  class="form-control" value="">
    </div>
    ...
    <div class="entry  row">
      ...
      <input class="form-control"  required="required" type="text" name="name[]" value=""/>
         ...
         <script src="js/jscolor.js"></script> 
         <input type="text"    required="required" name="fvalue[]" id="title"  class="jscolor form-control" value="">
    </div>
    ...
    <div class="entry  row">
      ...
      <input class="form-control" value="<?php echo $rowS[$j]['name']; ?>" required="required" type="text" name="name[]" value=""/>
         ...
         <input type="text"  value="<?php echo $rowS[$j]['fvalue']; ?>" title="ex. color, size etc" required="required" name="fvalue[]" id="title"  class="jscolor form-control" value="">
    </div>
...
$(document).on('click','.default_status',function(){
  var defaultid=$(this).val();
    $.ajax({
                type: "post",
                url: "make_default_child.php",
                data: {'default_id':defaultid,'customizetype':<?php echo $_REQUEST['pctype_id'] ?>,'typeid':<?php echo $_REQUEST['type'] ?>},
