...
if(isset($_GET['ids'])){
  ...
  if($sql){
    ...
    header("refresh:1;url=manage_order.php");
      ...
      <div class="content-wrapper">
        ...
        <form id="tab" name="form1" method="post" action="">
                <div class="box-header">
                  <a href="manage_order.php"><span class="btn btn-primary btn-small">All</span></a>
                  <a href="manage_order.php?status=1"><span class="btn btn-danger btn-small">Pending</span></a>
       <a href="manage_order.php?status=2"><span class="btn btn-warning btn-small">On Hold</span></a>
      <a href="manage_order.php?status=3"><span class="btn btn-danger btn-small">Canceled</span></a>
      <a href="manage_order.php?status=5"><span class="btn btn-success btn-small">Processing</span></a>
      <a href="manage_order.php?status=4"><span class="btn btn-info btn-small">Complete</span></a>
        ...
        <td> <input type="checkbox" value="<?php echo $row[$j]['id']; ?>" name="data[]" id="data" title="Select All" /></td> 
            ...
            <td><a href="view_order.php?edit=<?php echo $row[$j]['id'];?>"><span class="btn btn-success btn-xs"><i class="fa fa-eye"></i>View Order</span></a><a href="manage_order.php?ids=<?php echo $row[$j]['id'];?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure want to delete')">Delete</a></td>
