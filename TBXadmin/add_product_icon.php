...
{ 
   ...
   header("refresh:2;url=user_list");
	...
	$query = "SELECT * FROM product_varient_image order by id asc";
	$results = $objT->getResult($query);
  $arr = count($results);
  
  // $productname = "SELECT * FROM tbl_product where id = ".$results['product_id']"";
            ...
            <div class="col-xs-12">
			  ...
			  <form id="tab" name="form1" method="post" action="">
                <div class="box-header">
                  <h3 class="box-title">Add Product Icon</h3>
				  <div style="float:right;"><a href="add_product_icons.php"><span class="btn btn-success btn-small">Add Icon</span></a>
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>	
				              ...
				              <tr>
                        <td><?php echo $i; ?></td>
                        <td><?php echo $results[$x]['product_id']; ?></td>
                        
                        <td><?php echo $results[$x]['varient_img']; ?></td>
